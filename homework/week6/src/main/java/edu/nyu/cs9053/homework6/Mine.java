...
public class Mine {
    ...
    //private static final long PASS = CRC32s.crc32(String.valueOf(675693755L));
    ...
    public static void main(String[] args) {
        ...
        /*
        try{
            Method e = mine.getClass().getDeclaredMethod("getTools", new Class[0]);
            Safe safe = (Safe)e.getAnnotation(Safe.class);
            long password = safe.password();
            long pass = CRC32s.crc32(String.valueOf(675693755L));
